...
const requiredGraphicAndLanguageFragments = [
  ...
  '<span class="team-tooltip-name">Chi Buisson</span>',
  "body.view-concurrence .sidebar",
  'grid-template-areas:"marker copy" ". date"',
  '.comp-news-copy{grid-area:copy;min-width:0;display:flex;flex-direction:column',
  '<span class="comp-news-marker" aria-hidden="true"></span><div class="comp-news-copy">',
  'id="dpAiLanguage"',
  'id="addArtAiLanguage"',
